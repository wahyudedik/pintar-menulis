    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('analytics.index') }}" class="px-3 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700 transition">
                    📈 Full Analytics
                </a>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div class="space-y-3">
                    <div class="bg-white rounded-lg p-3 border border-green-100">
                        <p class="text-sm text-gray-800 line-clamp-2" id="dashBestCaption">
                            {{ $dashboardAnalytics['best_caption'] ?? '🔥 Flash Sale 50% OFF! Jangan sampai kehabisan, stock terbatas!' }}
                        </p>
                    </div>
                    <div class="grid grid-cols-2 gap-3 text-sm">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600" id="dashBestEngagement">{{ $dashboardAnalytics['best_engagement'] ?? '8.5' }}%</div>
                            <div class="text-green-700">Engagement</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600" id="dashBestReach">{{ number_format($dashboardAnalytics['best_reach'] ?? 5200) }}</div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border border-blue-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-blue-600" id="dashOptimalTime">{{ $dashboardAnalytics['optimal_time'] ?? '19:00' }}</div>
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-blue-900" id="dashBestDay">{{ $dashboardAnalytics['best_day'] ?? 'Tuesday' }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-blue-800">Avg Response:</span>
                            <span class="font-semibold text-blue-900" id="dashAvgResponse">{{ $dashboardAnalytics['avg_response'] ?? '2.5h' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-violet-50 rounded-lg border border-purple-200 p-6">
                ...
                <div class="space-y-4">
                    <div class="text-center">
                        <div class="text-3xl font-bold text-purple-600" id="dashAvgROI">{{ $dashboardAnalytics['avg_roi'] ?? '245' }}%</div>
                    ...
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-purple-900" id="dashTotalSales">{{ $dashboardAnalytics['total_sales'] ?? 'Rp 15.2M' }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-purple-800">Marketing Cost:</span>
                            <span class="font-semibold text-purple-900" id="dashMarketingCost">{{ $dashboardAnalytics['marketing_cost'] ?? 'Rp 4.8M' }}</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    <div class="w-20 bg-gray-200 rounded-full h-2 mr-2">
                                        <div class="bg-pink-500 h-2 rounded-full" style="width: {{ $platformPerformance['instagram'] ?? 85 }}%"></div>
                                    </div>
                                    <span class="text-sm font-medium">{{ $platformPerformance['instagram'] ?? 85 }}%</span>
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                ...
                                <div class="flex items-center">
                                    <div class="w-20 bg-gray-200 rounded-full h-2 mr-2">
                                        <div class="bg-blue-500 h-2 rounded-full" style="width: {{ $platformPerformance['facebook'] ?? 72 }}%"></div>
                                    </div>
                                    <span class="text-sm font-medium">{{ $platformPerformance['facebook'] ?? 72 }}%</span>
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                ...
                                <div class="flex items-center">
                                    <div class="w-20 bg-gray-200 rounded-full h-2 mr-2">
                                        <div class="bg-black h-2 rounded-full" style="width: {{ $platformPerformance['tiktok'] ?? 68 }}%"></div>
                                    </div>
                                    <span class="text-sm font-medium">{{ $platformPerformance['tiktok'] ?? 68 }}%</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg border border-indigo-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <a href="{{ route('ai.generator') }}" class="bg-white rounded-lg p-4 border border-indigo-200 hover:shadow-md transition group">
                ...
                <a href="{{ route('analytics.index') }}" class="bg-white rounded-lg p-4 border border-indigo-200 hover:shadow-md transition group">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-2xl">📊</span>
                        <svg class="w-4 h-4 text-indigo-600 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
