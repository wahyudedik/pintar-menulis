...
<div class="p-6 max-w-lg mx-auto">
    <div class="flex items-center gap-3 mb-6">
        <a href="{{ route('client.referral.index') }}" class="text-gray-400 hover:text-gray-600">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <form action="{{ route('client.referral.withdraw.store') }}" method="POST">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="account_name" required value="{{ old('account_name', $user->name) }}"
                       class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300">
