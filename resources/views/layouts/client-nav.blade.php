            ...
            <div class="flex items-center">
                ...
                <div class="flex items-center space-x-1">
                    ...
                    <div class="relative" x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                        <button class="inline-flex items-center gap-1 px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('analytics*') || request()->routeIs('caption-history*') || request()->routeIs('image-caption*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                    ...
                    {{-- Tools --}}
                    <div class="relative" x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                        <button class="inline-flex items-center gap-1 px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('brand-voices*') || request()->routeIs('projects*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                    ...
                    {{-- Akun --}}
                    <div class="relative" x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                        <button class="inline-flex items-center gap-1 px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('orders*') || request()->routeIs('subscription*') || request()->routeIs('feedback*') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
