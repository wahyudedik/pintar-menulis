...
<a href="{{ route('ai.generator') }}" 
   class="tooltip flex items-center justify-center w-12 h-12 rounded-lg transition {{ request()->routeIs('ai.generator') || request()->routeIs('bulk-content.*') || request()->routeIs('caption-history.*') || request()->routeIs('my-stats') ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-100' }}"
...
<!-- Referral -->
<a href="{{ route('client.referral.index') }}" 
   class="tooltip flex items-center justify-center w-12 h-12 rounded-lg transition {{ request()->routeIs('client.referral.*') ? 'bg-green-50 text-green-600' : 'text-gray-600 hover:bg-gray-100' }}"
