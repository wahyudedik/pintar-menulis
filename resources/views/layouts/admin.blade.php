...
<a href="{{ route('admin.marketplace.index') }}" 
   class="tooltip flex items-center justify-center w-12 h-12 rounded-lg transition {{ request()->routeIs('admin.marketplace*') ? 'bg-red-50 text-red-600' : 'text-gray-600 hover:bg-gray-100' }}"
...
<a href="{{ route('admin.operators.index') }}" 
   class="tooltip flex items-center justify-center w-12 h-12 rounded-lg transition {{ request()->routeIs('admin.operators*') ? 'bg-red-50 text-red-600' : 'text-gray-600 hover:bg-gray-100' }}"
