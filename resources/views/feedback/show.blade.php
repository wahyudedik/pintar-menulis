...
<div class="p-6">
    <div class="max-w-3xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
            <a href="{{ route('feedback.index') }}" class="text-sm text-gray-600 hover:text-gray-900 mb-2 inline-block">
                ← Back to My Feedback
            </a>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
            ...
            <div class="pt-6 border-t border-gray-200 grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                    ...
                    <a href="{{ $feedback->page_url }}" target="_blank" class="text-blue-600 hover:underline break-all text-xs">
                        {{ $feedback->page_url }}
                    </a>
                </div>
                @endif
        ...
        <div class="mt-6 bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                ...
                @if($feedback->status === 'in_progress' || $feedback->status === 'resolved' || $feedback->status === 'closed')
                <div class="flex items-start space-x-3">
