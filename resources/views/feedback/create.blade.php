...
<div class="p-6" x-data="feedbackForm()">
    <div class="max-w-3xl mx-auto">
        ...
        <!-- Form -->
        <form action="{{ route('feedback.store') }}" method="POST" class="bg-white rounded-lg border border-gray-200 p-6">
            @csrf
            ...
            <div class="flex space-x-3">
                <a href="{{ route('feedback.index') }}" class="flex-1 px-4 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition text-center">
                    Batal
                </a>
