...
<div class="p-6" x-data="workspace()">
    <div class="mb-6">
        <a href="<?php echo e(route('operator.queue')); ?>" class="text-green-600 hover:text-green-700 text-sm">
            ← Kembali ke Queue
        </a>
    </div>
    ...
    <div class="grid lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4 sticky top-6">
                ...
                <div class="space-y-3">
                    <div>
                        ...
                        <p class="font-medium text-sm"><?php echo e($order->user->name); ?></p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="font-medium text-red-600 text-sm"><?php echo e($order->deadline->format('d M Y')); ?></p>
        ...
        <div class="lg:col-span-2">
            ...
            <!-- Work Form -->
            <form method="POST" action="<?php echo e(route('operator.submit', $order)); ?>" class="bg-white rounded-lg border border-gray-200 p-4">
                <?php echo csrf_field(); ?>
    ...
    function workspace() {
        return {
            ...
            async generateAI() {
                ...
                try {
                    const response = await fetch('<?php echo e(route("api.ai.generate")); ?>', {
                        method: 'POST',
                        headers: {
                        ...
                        body: JSON.stringify({
                            category: '<?php echo e($order->category); ?>',
                            subcategory: '<?php echo e($order->category); ?>',
                            platform: 'general',
                            brief: '<?php echo e(addslashes($order->brief)); ?>',
                            tone: this.aiTone,
...
<?php echo $__env->make('layouts.operator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\operator\workspace.blade.php ENDPATH**/ ?>