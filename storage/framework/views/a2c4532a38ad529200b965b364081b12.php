...
<?php $__env->startSection('description', 'Hubungi Noteds - Customer Support & Bantuan'); ?>
            ...
            <div class="flex-1">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-sm text-gray-600 mt-2">
                        Lihat <a href="<?php echo e(route('refund-policy')); ?>" class="text-blue-600 hover:underline">Refund Policy</a> untuk informasi lengkap
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('legal.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\legal\contact.blade.php ENDPATH**/ ?>