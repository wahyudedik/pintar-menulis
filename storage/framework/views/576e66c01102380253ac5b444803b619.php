<section>
    ...
    <?php if(session('status') === 'google-disconnected'): ?>
    ...
    <div class="mt-6 space-y-4">
        ...
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div>
                <?php if($user->google_id): ?>
                    <form method="POST" action="<?php echo e(route('profile.disconnect-google')); ?>" onsubmit="return confirm('Are you sure you want to disconnect your Google account?');">
                        <?php echo csrf_field(); ?>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('auth.google')); ?>" class="px-4 py-2 text-sm font-medium text-blue-600 hover:text-blue-700 border border-blue-300 rounded-lg hover:bg-blue-50 transition inline-block">
                        Connect Google
                    </a>
                <?php endif; ?>
            </div>
...
<?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\profile\partials\google-account-management.blade.php ENDPATH**/ ?>