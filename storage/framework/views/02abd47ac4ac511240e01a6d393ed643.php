...
<div class="px-4 py-6 max-w-lg mx-auto" x-data="{
    gateway: '<?php echo e(in_array('manual_transfer', $enabledGateways) ? 'manual_transfer' : ($enabledGateways[0] ?? '')); ?>',
    bank: '',
    uploading: false
}">

    <a href="<?php echo e(route('pricing')); ?>" class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 mb-6">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-4 mb-5">
        ...
        <div class="space-y-0 text-sm">
            <div class="flex justify-between py-2 border-b border-gray-100">
                ...
                <span class="font-medium"><?php echo e($package->name); ?></span>
            </div>
            <div class="flex justify-between py-2 border-b border-gray-100">
                <span class="text-gray-500">Periode</span>
                <span class="font-medium"><?php echo e($billingCycle === 'yearly' ? 'Tahunan (12 bulan)' : 'Bulanan'); ?></span>
            </div>
            <div class="flex justify-between py-2 border-b border-gray-100">
                <span class="text-gray-500">Kuota AI</span>
                <span class="font-medium"><?php echo e(number_format($package->ai_quota_monthly)); ?>/bulan</span>
            </div>
            <div class="flex justify-between pt-2">
                <span class="font-semibold text-gray-900">Total</span>
                <span class="text-lg font-bold text-red-600">Rp <?php echo e(number_format($price, 0, ',', '.')); ?></span>
            </div>
        </div>
    </div>
    ...
    <form action="<?php echo e(route('subscription.pay', $package)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-4 mb-5">
            ...
            <div class="space-y-2">
                ...
                <?php if(in_array('midtrans', $enabledGateways)): ?>
                ...
                <?php if(in_array('xendit', $enabledGateways)): ?>
                <label class="flex items-center gap-3 p-3 border-2 rounded-xl cursor-pointer transition"
                ...
                <?php if(in_array('manual_transfer', $enabledGateways)): ?>
                <label class="flex items-center gap-3 p-3 border-2 rounded-xl cursor-pointer transition"
        ...
        <div x-show="gateway === 'manual_transfer'" x-cloak class="mb-5 space-y-4">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-4">
                ...
                <div class="space-y-2">
                    <?php $__currentLoopData = $manualBanks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="flex items-center gap-3 p-3 border-2 rounded-xl cursor-pointer transition"
                           :class="bank === '<?php echo e($bankItem->bank_name); ?>' ? 'border-gray-700 bg-gray-50' : 'border-gray-200 hover:border-gray-300'">
                        <input type="radio" name="payment_method" value="<?php echo e($bankItem->bank_name); ?>"
                               x-model="bank" class="sr-only">
                        <div class="flex-1 min-w-0">
                            <p class="font-semibold text-gray-900 text-sm"><?php echo e($bankItem->bank_name); ?></p>
                            <p class="text-xs text-gray-600 font-mono"><?php echo e($bankItem->account_number); ?></p>
                            <p class="text-xs text-gray-500">a.n. <?php echo e($bankItem->account_name); ?></p>
                        </div>
                        <?php if($bankItem->qr_code_path): ?>
                        <img src="<?php echo e(asset('storage/' . $bankItem->qr_code_path)); ?>" alt="QR"
                ...
                <p class="text-xs text-gray-500 mt-3">
                    Transfer tepat <strong>Rp <?php echo e(number_format($price, 0, ',', '.')); ?></strong> untuk mempercepat verifikasi.
                </p>
            </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\client\subscription\checkout.blade.php ENDPATH**/ ?>