<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">
            <?php if($user->google_id && (!$user->password || strlen($user->password) < 10)): ?>
        ...
        <p class="mt-1 text-sm text-gray-600">
            <?php if($user->google_id && (!$user->password || strlen($user->password) < 10)): ?>
                <?php echo e(__('Set a password to enable email/password login alongside your Google account.')); ?>
...
<?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\profile\partials\update-password-form.blade.php ENDPATH**/ ?>