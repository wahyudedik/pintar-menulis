...
<?php $__env->startSection('title', 'Browse Operators'); ?>
...
function browseOperators() {
    return {
        operators: <?php echo json_encode($operators, 15, 512) ?>,
        filters: {
            category: '',
            rating: '',
            price: '',
        ...
        async submitOrder() {
            ...
            try {
                ...
                const response = await fetch('<?php echo e(route('request.order')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\client\browse-operators.blade.php ENDPATH**/ ?>