...
<head>
    ...
    <title><?php echo e(config('app.name', 'Noteds')); ?></title>
    
    <!-- SEO Meta Tags -->
    <meta name="description" content="<?php echo e(config('app.name', 'Noteds')); ?> - AI Caption Generator untuk UMKM Indonesia">
    <meta name="keywords" content="caption generator, AI, UMKM, digital marketing">
    
    <!-- Open Graph Tags -->
    <meta property="og:title" content="<?php echo e(config('app.name', 'Noteds')); ?>">
    <meta property="og:description" content="<?php echo e(config('app.name', 'Noteds')); ?> - AI Caption Generator untuk UMKM Indonesia">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-3">
                    ...
                    <a href="/" class="text-lg font-semibold text-gray-900"><?php echo e(config('app.name', 'Noteds')); ?></a>
                </div>
                <div class="flex items-center space-x-3">
    ...
    <footer class="bg-gray-900 text-gray-300 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    <div class="flex items-center space-x-2 mb-4">
                        <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" class="w-8 h-8 rounded-lg object-cover">
                        <span class="font-semibold text-white"><?php echo e(config('app.name', 'Noteds')); ?></span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="<?php echo e(route('articles.index')); ?>" class="text-gray-400 hover:text-white transition">Daftar Gratis</a></li>
                        <li><a href="<?php echo e(route('login')); ?>" class="text-gray-400 hover:text-white transition">Login</a></li>
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'Noteds')); ?>. All rights reserved.</p>
...
<?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\layouts\public.blade.php ENDPATH**/ ?>