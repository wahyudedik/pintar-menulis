                ...
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                               class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php echo e($errors->has('email') ? 'border-red-400 bg-red-50' : 'border-gray-300'); ?>">
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:text-blue-700">
                                Lupa password?
                            </a>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH E:\PROJEKU\pintar-menulis\resources\views/auth/login.blade.php ENDPATH**/ ?>