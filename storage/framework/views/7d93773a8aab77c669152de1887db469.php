        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($stats['approved']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1"><?php echo e($stats['completed']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xl font-bold text-gray-900 mt-1">Rp <?php echo e(number_format($stats['total_amount'], 0, ',', '.')); ?></p>
                </div>
        ...
        <div class="p-4 space-y-4">
            ...
            <div class="border border-gray-200 rounded-lg p-4">
                <div class="flex justify-between items-start mb-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-2 mb-2">
                            <h3 class="text-base font-semibold text-gray-900"><?php echo e($withdrawal->user->name); ?></h3>
                            <span class="px-2 py-0.5 text-xs font-medium rounded-full <?php echo e($withdrawal->user->isGuru() ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'); ?>">
                                <?php echo e(ucfirst($withdrawal->user->role)); ?>

                            </span>
                            <span class="px-2 py-1 text-xs font-medium rounded
                                <?php if($withdrawal->status === 'pending'): ?> bg-yellow-100 text-yellow-700
                                <?php elseif($withdrawal->status === 'approved'): ?> bg-blue-100 text-blue-700
                                <?php elseif($withdrawal->status === 'completed'): ?> bg-green-100 text-green-700
                        ...
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <p class="font-bold text-red-600">Rp <?php echo e(number_format($withdrawal->amount, 0, ',', '.')); ?></p>
                            </div>
                            <div>
                                <p class="text-gray-600">Bank Account</p>
                                <p class="font-medium text-gray-900"><?php echo e($withdrawal->bank_name); ?> - <?php echo e($withdrawal->account_number); ?></p>
                                <p class="text-xs text-gray-500"><?php echo e($withdrawal->account_name); ?></p>
                            </div>
                            <div>
                                <p class="text-gray-600">Requested</p>
                                <p class="font-medium text-gray-900"><?php echo e($withdrawal->created_at->format('d M Y H:i')); ?></p>
                            </div>
                            <?php if($withdrawal->processed_at): ?>
                            <div>
                                <p class="text-gray-600">Processed</p>
                                <p class="font-medium text-gray-900"><?php echo e($withdrawal->processed_at->format('d M Y H:i')); ?></p>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mt-3 p-3 bg-gray-50 rounded-lg">
                            ...
                            <p class="text-sm text-gray-800"><?php echo e($withdrawal->admin_notes); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="flex gap-3 pt-4 border-t border-gray-200">
                    <form action="<?php echo e(route('admin.withdrawals.approve', $withdrawal)); ?>" method="POST" class="flex-1">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
                    ...
                    <button onclick="showRejectModal(<?php echo e($withdrawal->id); ?>)"
                ...
                <div class="pt-4 border-t border-gray-200">
                    <form action="<?php echo e(route('admin.withdrawals.complete', $withdrawal)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\admin\withdrawals.blade.php ENDPATH**/ ?>