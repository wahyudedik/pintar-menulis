...
<?php $__env->startSection('title', $project->business_name); ?>
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <div class="flex items-center space-x-3 mb-2">
                <h1 class="text-2xl font-semibold text-gray-900"><?php echo e($project->business_name); ?></h1>
                <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full"><?php echo e(ucfirst($userRole)); ?></span>
            </div>
            <p class="text-sm text-gray-500"><?php echo e($project->business_type); ?> • <?php echo e($stats['team_members']); ?> anggota tim</p>
        </div>
        <div class="flex items-center space-x-3">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('projects.collaboration.workspace', $project)); ?>" 
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($stats['total_content']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($stats['drafts']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($stats['pending_review']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($stats['approved']); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-4">
            <div class="flex items-center">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($stats['team_members']); ?></p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="flex items-start space-x-3 p-3 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    By <?php echo e($content->creator->name); ?> • <?php echo e(ucfirst($content->content_type)); ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg border border-gray-200">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <?php if($canApprove && $stats['pending_review'] > 0): ?>
                    <a href="<?php echo e(route('projects.content.index', $project)); ?>?status=review" 
                       class="flex items-center p-3 text-sm text-orange-700 bg-orange-50 hover:bg-orange-100 rounded-lg transition">
                        ...
                        Review Pending Content (<?php echo e($stats['pending_review']); ?>)
                    </a>
                    <?php endif; ?>
                    ...
                    <?php if($project->isOwner(auth()->user())): ?>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views/projects/show.blade.php ENDPATH**/ ?>