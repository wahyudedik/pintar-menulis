<?php $__env->startSection('title', 'Order Queue'); ?>
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="mb-4">
            ...
            <p class="text-sm text-gray-500 mt-1"><?php echo e($myOrders->count()); ?> order aktif</p>
        </div>
            ...
            <div class="bg-white rounded-lg border border-gray-200 border-l-4 border-l-blue-500 p-4">
                <div class="flex justify-between items-start mb-3">
                    <div>
                        ...
                        <p class="text-xs text-gray-600">Client: <?php echo e($order->user->name); ?></p>
                    </div>
                ...
                <div class="bg-gray-50 rounded p-3 mb-3">
                    ...
                    <p class="text-sm text-gray-800"><?php echo e($order->brief); ?></p>
                </div>

                <div class="grid grid-cols-2 gap-3 mb-3">
                    <div>
                        <p class="text-xs text-gray-500">Budget</p>
                        <p class="text-base font-semibold text-green-600">Rp <?php echo e(number_format($order->budget, 0, ',', '.')); ?></p>
                    </div>
                    <div>
                        <p class="text-xs text-gray-500">Deadline</p>
                        <p class="text-sm font-medium text-red-600"><?php echo e($order->deadline->format('d M Y')); ?></p>
                    </div>
                </div>

                <div class="flex gap-2">
                    <a href="<?php echo e(route('operator.workspace', $order)); ?>" 
                       class="flex-1 bg-blue-600 text-white text-center px-3 py-2 rounded-lg hover:bg-blue-700 transition text-sm">
                        Kerjakan
                    </a>
                    <form method="POST" action="<?php echo e(route('operator.reject', $order)); ?>" class="flex-1">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
    ...
    <div>
        <div class="mb-4">
            ...
            <p class="text-sm text-gray-500 mt-1"><?php echo e($orders->count()); ?> order menunggu</p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-4 hover:border-green-300 transition">
                ...
                <form method="POST" action="<?php echo e(route('operator.accept', $order)); ?>">
                    <?php echo csrf_field(); ?>
                    <button type="submit" 
...
<?php echo $__env->make('layouts.operator', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\operator\queue.blade.php ENDPATH**/ ?>