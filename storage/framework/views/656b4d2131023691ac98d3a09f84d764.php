                <form @submit.prevent="generateCopywriting" x-show="generatorType === 'text' && mode === 'simple'" x-cloak>
                    ...
                    <button type="submit" :disabled="loading"
                        ...
                        <span x-show="!loading">🚀 Bikin Sekarang! <span class="text-blue-200 text-xs ml-1" x-text="'(' + (creditCosts.generate || 1) + ' kredit)'"></span></span>
                        <span x-show="loading" class="flex items-center justify-center gap-2">
                            <svg class="animate-spin h-5 w-5" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                            </svg>
                            <span x-text="_loadingSeconds < 5 ? 'Sedang Bikin...' : (_loadingSeconds < 15 ? 'Masih proses... (' + _loadingSeconds + 's)' : 'Hampir selesai... (' + _loadingSeconds + 's)')"></span>
                        </span>
                    </button>
...
<?php /**PATH E:\PROJEKU\pintar-menulis\resources\views/client/partials/ai-generator/form-text-simple.blade.php ENDPATH**/ ?>