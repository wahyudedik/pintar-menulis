...
<?php $__env->startSection('title', 'Competitor Comparison'); ?>
...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500 mt-1">Bandingkan performa <?php echo e($competitors->count()); ?> kompetitor untuk strategi yang lebih baik</p>
    </div>

    <!-- AI Insights Summary -->
    <?php if(isset($comparisonInsights) && is_array($comparisonInsights)): ?>
            ...
            <div class="flex-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <?php if(isset($comparisonInsights['winner_reasons']) && is_array($comparisonInsights['winner_reasons'])): ?>
                        <ul class="text-xs text-purple-700 mt-1">
                            <?php $__currentLoopData = $comparisonInsights['winner_reasons']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div>
                        ...
                        <?php if(isset($comparisonInsights['opportunities']) && is_array($comparisonInsights['opportunities'])): ?>
                        <ul class="text-sm text-purple-700">
                            <?php $__currentLoopData = array_slice($comparisonInsights['opportunities'], 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $opportunity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>• <?php echo e($opportunity); ?></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                        <?php else: ?>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm font-medium text-gray-900"><?php echo e($competitor->username); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($competitor->profile_name ?? 'N/A'); ?></p>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800 capitalize">
                                <?php echo e($competitor->platform); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e(number_format($competitor->followers_count)); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <?php echo e($competitor->analysisSummary->first()->total_posts ?? 'N/A'); ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            ?>
                            <span class="text-sm font-medium <?php echo e($engagementColor); ?>">
                                <?php echo e(number_format($engagementRate, 1)); ?>%
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-700">
                                <?php echo e($competitor->category ?? 'General'); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <?php if(isset($comparisonInsights['key_insights']) && is_array($comparisonInsights['key_insights'])): ?>
            <ul class="space-y-3">
                <?php $__currentLoopData = $comparisonInsights['key_insights']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-start space-x-3">
                    <div class="flex-shrink-0 w-2 h-2 bg-blue-600 rounded-full mt-2"></div>
                    <p class="text-sm text-gray-700"><?php echo e($insight); ?></p>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            <?php else: ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <?php if(isset($comparisonInsights['recommendations']) && is_array($comparisonInsights['recommendations'])): ?>
            <ul class="space-y-3">
                <?php $__currentLoopData = $comparisonInsights['recommendations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recommendation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex items-start space-x-3">
                    <div class="flex-shrink-0 w-2 h-2 bg-green-600 rounded-full mt-2"></div>
                    <p class="text-sm text-gray-700"><?php echo e($recommendation); ?></p>
                </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
            <?php else: ?>
        ...
        <div class="mb-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center space-x-4">
                    <div class="w-24 text-sm text-gray-600 truncate"><?php echo e($competitor->username); ?></div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            <div class="flex items-center space-x-3 mb-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 capitalize"><?php echo e($competitor->platform); ?> • <?php echo e($competitor->category); ?></p>
                </div>
            </div>

            <?php $latestSummary = $competitor->analysisSummary->first(); ?>
            <?php if($latestSummary): ?>
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Followers</span>
                    <span class="text-sm font-medium text-gray-900"><?php echo e(number_format($competitor->followers_count)); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Posts</span>
                    <span class="text-sm font-medium text-gray-900"><?php echo e($latestSummary->total_posts); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Avg Engagement</span>
                    <span class="text-sm font-medium text-gray-900"><?php echo e(number_format($latestSummary->avg_engagement_rate, 1)); ?>%</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-sm text-gray-600">Avg Likes</span>
                    <span class="text-sm font-medium text-gray-900"><?php echo e(number_format($latestSummary->avg_likes)); ?></span>
                </div>
                
                <!-- Content Gaps -->
                <?php if($competitor->contentGaps->isNotEmpty()): ?>
                <div class="pt-3 border-t border-gray-200">
                    <p class="text-xs text-gray-600 mb-2">Content Opportunities</p>
                    <div class="space-y-1">
                        <?php $__currentLoopData = $competitor->contentGaps->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center space-x-2">
                            <div class="w-2 h-2 bg-yellow-500 rounded-full"></div>
                            <span class="text-xs text-gray-700"><?php echo e($gap->gap_title); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
...
function exportComparison() {
    try {
        ...
        const competitors = <?php echo json_encode($exportData ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\client\competitor-analysis\compare.blade.php ENDPATH**/ ?>