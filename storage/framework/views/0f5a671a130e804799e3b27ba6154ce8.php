...
<?php $__env->startSection('title', 'Detail Kompetitor - ' . $competitor->username); ?>
...
<div class="p-6">
    ...
    <div class="mb-6">
        <div class="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            ...
            <span>/</span>
            <span class="text-gray-900"><?php echo e($competitor->username); ?></span>
        </div>
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900"><?php echo e($competitor->username); ?></h1>
                    <div class="flex items-center space-x-3 mt-1">
                        <span class="text-sm text-gray-500 capitalize"><?php echo e($competitor->platform); ?></span>
                        <?php if($competitor->category): ?>
                        <span class="px-2 py-0.5 bg-purple-100 text-purple-700 text-xs rounded"><?php echo e($competitor->category); ?></span>
                        <?php endif; ?>
            ...
            <div class="flex items-center space-x-2">
                ...
                <form action="<?php echo e(route('competitor-analysis.toggle-active', $competitor)); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
                    <button type="submit" 
                            class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition">
                        <?php echo e($competitor->is_active ? 'Nonaktifkan' : 'Aktifkan'); ?>

                    </button>
                </form>
                <form action="<?php echo e(route('competitor-analysis.destroy', $competitor)); ?>" method="POST" class="inline" 
    ...
    <!-- Analysis Status -->
    <?php if(!$latestSummary && $competitor->created_at->diffInMinutes(now()) < 15): ?>
    ...
    <div data-analysis-complete class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e($latestSummary->total_posts); ?></p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e(number_format($latestSummary->avg_engagement_rate, 1)); ?>%</p>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p class="text-3xl font-bold text-gray-900"><?php echo e($latestSummary->posting_frequency ?? 0); ?></p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <p class="text-2xl font-bold text-gray-900"><?php echo e($latestSummary->best_posting_time ?? 'N/A'); ?></p>
        </div>
    </div>
    <?php else: ?>
    ...
    <!-- Content Tabs -->
    <?php if($latestSummary || $competitor->patterns->isNotEmpty() || $recentPosts->isNotEmpty()): ?>
    <div class="bg-white rounded-xl border border-gray-200" x-data="{ tab: 'patterns' }">
        ...
        <div class="p-6">
            ...
            <div x-show="tab === 'patterns'" x-cloak>
                <?php if($competitor->patterns->isEmpty()): ?>
                <p class="text-center text-gray-500 py-8">Belum ada data pattern</p>
                <?php else: ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $competitor->patterns->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pattern): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 bg-gray-50 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            <span class="px-2 py-1 bg-purple-100 text-purple-700 text-xs rounded font-medium">
                                <?php echo e(ucfirst(str_replace('_', ' ', $pattern->pattern_type))); ?>

                            </span>
                            <span class="text-xs text-gray-500"><?php echo e($pattern->analysis_date->format('d M Y')); ?></span>
                        </div>
                        <p class="text-sm text-gray-700"><?php echo e($pattern->insights ?? 'No insights available'); ?></p>
                        <?php if($pattern->pattern_data): ?>
                        <div class="mt-2 text-xs text-gray-600">
                            <pre class="bg-white p-2 rounded border border-gray-200 overflow-x-auto"><?php echo e(json_encode($pattern->pattern_data, JSON_PRETTY_PRINT)); ?></pre>
                        </div>
                        <?php endif; ?>
                    </div>
            ...
            <div x-show="tab === 'top-content'" x-cloak>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php $__currentLoopData = $topPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 bg-gray-50 rounded-lg">
                        <div class="flex items-start justify-between mb-2">
                            <span class="px-2 py-1 bg-green-100 text-green-700 text-xs rounded font-medium">
                                #<?php echo e($topContent->rank); ?>

                            </span>
                            <span class="text-xs text-gray-500"><?php echo e($topContent->post->posted_at->format('d M Y')); ?></span>
                        </div>
                        <p class="text-sm text-gray-900 mb-2 line-clamp-3"><?php echo e($topContent->post->caption); ?></p>
                        <div class="flex items-center space-x-4 text-xs text-gray-600">
                            <span>❤️ <?php echo e(number_format($topContent->post->likes_count)); ?></span>
                            <span>💬 <?php echo e(number_format($topContent->post->comments_count)); ?></span>
                            <span>📊 <?php echo e(number_format($topContent->post->engagement_rate, 1)); ?>%</span>
                        </div>
                        <?php if($topContent->success_factors): ?>
                        <div class="mt-2 p-2 bg-white rounded border border-gray-200">
                            <p class="text-xs text-gray-600"><?php echo e($topContent->success_factors); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div x-show="tab === 'content-gaps'" x-cloak>
                <?php if($competitor->contentGaps->isEmpty()): ?>
                <p class="text-center text-gray-500 py-8">Belum ada content gap teridentifikasi</p>
                <?php else: ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $competitor->contentGaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-lg border border-purple-200">
                        <div class="flex items-start justify-between mb-2">
                            <div class="flex items-center space-x-2">
                                <span class="px-2 py-1 bg-purple-600 text-white text-xs rounded font-medium">
                                    Priority: <?php echo e($gap->priority); ?>

                                </span>
                                <span class="px-2 py-1 bg-white text-gray-700 text-xs rounded">
                                    <?php echo e(ucfirst($gap->gap_type)); ?>

                                </span>
                            </div>
                            <?php if(!$gap->is_implemented): ?>
                            <form action="<?php echo e(route('competitor-analysis.gap.implement', $gap)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                        ...
                        <h4 class="font-semibold text-gray-900 mb-1"><?php echo e($gap->gap_title); ?></h4>
                        <p class="text-sm text-gray-700 mb-2"><?php echo e($gap->gap_description); ?></p>
                        <?php if($gap->suggested_content): ?>
                        <div class="mt-2 p-3 bg-white rounded border border-purple-200">
                            ...
                            <?php if(is_array($gap->suggested_content)): ?>
                                ...
                                <p class="text-sm text-gray-700 mb-1">• <?php echo e($suggestion); ?></p>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                                <p class="text-sm text-gray-700"><?php echo e($gap->suggested_content); ?></p>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
                    </div>
            ...
            <div x-show="tab === 'recent-posts'" x-cloak>
                ...
                <div class="space-y-4">
                    ...
                    <div class="p-4 bg-gray-50 rounded-lg">
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-xs text-gray-500"><?php echo e($post->posted_at->format('d M Y H:i')); ?></span>
                            <div class="flex items-center space-x-3 text-xs text-gray-600">
                                <span>❤️ <?php echo e(number_format($post->likes_count)); ?></span>
                                <span>💬 <?php echo e(number_format($post->comments_count)); ?></span>
                                <span>📊 <?php echo e(number_format($post->engagement_rate, 1)); ?>%</span>
                            </div>
                        </div>
                        <p class="text-sm text-gray-900 mb-2"><?php echo e($post->caption); ?></p>
                        ...
                        <div class="flex flex-wrap gap-1">
                            ...
                            <span class="px-2 py-0.5 bg-blue-100 text-blue-700 text-xs rounded"><?php echo e($hashtag); ?></span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\client\competitor-analysis\show.blade.php ENDPATH**/ ?>