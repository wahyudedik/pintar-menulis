...
<div class="p-6 max-w-3xl">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">Edit Paket: <?php echo e($package->name); ?></h1>
    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" rows="2" required
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent"><?php echo e(old('description', $package->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="price" value="<?php echo e(old('price', $package->price)); ?>" required min="0"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="yearly_price" value="<?php echo e(old('yearly_price', $package->yearly_price)); ?>" min="0"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
                    <p class="text-xs text-gray-400 mt-1">Kosongkan untuk otomatis (10× bulanan)</p>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Urutan Tampil</label>
                    <input type="number" name="sort_order" value="<?php echo e(old('sort_order', $package->sort_order ?? 0)); ?>" min="0"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" name="ai_quota_monthly" value="<?php echo e(old('ai_quota_monthly', $package->ai_quota_monthly)); ?>" required min="0"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="caption_quota" value="<?php echo e(old('caption_quota', $package->caption_quota)); ?>" min="0"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Product Description Quota</label>
                    <input type="number" name="product_description_quota" value="<?php echo e(old('product_description_quota', $package->product_description_quota)); ?>" min="0"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="badge_text" value="<?php echo e(old('badge_text', $package->badge_text)); ?>" placeholder="Contoh: PALING POPULER"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
                </div>
                <div>
                    ...
                    <select name="badge_color"
                        ...
                        <option value="<?php echo e($val); ?>" <?php echo e(old('badge_color', $package->badge_color) === $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Durasi Trial (hari)</label>
                    <input type="number" name="trial_days" value="<?php echo e(old('trial_days', $package->trial_days ?? 30)); ?>" min="0"
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-transparent">
                </div>
            </div>

            
            <?php $activeFeatures = old('allowed_features', $package->getAllowedFeaturesList()); ?>
            ...
            <div class="space-y-3 mb-6">
                <label class="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" name="has_trial" value="1" <?php echo e(old('has_trial', $package->has_trial) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\admin\package-edit.blade.php ENDPATH**/ ?>