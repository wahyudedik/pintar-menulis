...
<?php $__env->startSection('title', 'Generate Bulk Content'); ?>
    ...
    <div class="bg-white rounded-lg border border-gray-200 p-6">
        <form id="bulkContentForm" class="space-y-6">
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                <a href="<?php echo e(route('bulk-content.index')); ?>" class="text-sm text-gray-600 hover:text-gray-900">
                    Cancel
                </a>
                <button type="submit" 
                    id="generateBtn"
...
document.getElementById('bulkContentForm').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch('<?php echo e(route("bulk-content.generate")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\client\bulk-content\create.blade.php ENDPATH**/ ?>