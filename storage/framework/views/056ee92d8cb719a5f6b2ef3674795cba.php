...
<?php $__env->startSection('description', 'Syarat dan Ketentuan Layanan Noteds'); ?>
...
<div class="prose prose-blue max-w-none">
    ...
    <p class="text-gray-700 mb-4">
        Lihat <a href="<?php echo e(route('refund-policy')); ?>" class="text-blue-600 hover:underline">Refund Policy</a> untuk detail lengkap tentang kebijakan pengembalian dana.
    </p>
...
<?php echo $__env->make('legal.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\legal\terms-of-service.blade.php ENDPATH**/ ?>