...
<?php $__env->startSection('title', 'Upload Foto Produk'); ?>
...
<div class="p-6 max-w-4xl mx-auto">
    ...
    <form action="<?php echo e(route('image-caption.store')); ?>" method="POST" enctype="multipart/form-data" id="uploadForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
                <a href="<?php echo e(route('image-caption.index')); ?>" class="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition">
                    Batal
                </a>
...
<?php echo $__env->make('layouts.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\PROJEKU\pintar-menulis\resources\views\client\image-caption\create.blade.php ENDPATH**/ ?>